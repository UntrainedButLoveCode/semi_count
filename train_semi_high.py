...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default='high') # high
    parser.add_argument('--data_root', default='high',
                        help='path where the dataset is')
    
    parser.add_argument('--output_dir', default='./res/high/logs',
                        help='path where to save, empty for no saving')
    parser.add_argument('--checkpoints_dir', default='./res/high/weights',
                        help='path where to save checkpoints, empty for no saving')
    parser.add_argument('--tensorboard_dir', default='./res/high/logs',
                        help='path where to save, empty for no saving')
...
if __name__ == '__main__':
    ...
    if args.label_pro == '10':
        uncertain_folder = 'high/uncertain_data_10/'
    elif args.label_pro == '5':
        uncertain_folder = 'high/uncertain_data_5/'
    elif args.label_pro == '40':
        uncertain_folder = 'high/uncertain_data_40/'
     
    dataset_t_ik = crowd_test(
        imgdir = uncertain_folder,
        maskdir='high/uncertain_label/',
