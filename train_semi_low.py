...
def get_args_parser():
    ...
    parser.add_argument('--checkpoints_dir', default='./res/low/weights',
                        help='path where to save checkpoints, empty for no saving')
    parser.add_argument('--tensorboard_dir', default='./res/low/logs',
                        help='path where to save, empty for no saving')
...
if __name__ == '__main__':
    ...
    if args.label_pro == '10':
        uncertain_folder = 'low/uncertain_data_10/'
    elif args.label_pro == '5':
        uncertain_folder = 'low/uncertain_data_5/'
    elif args.label_pro == '40':
        uncertain_folder = 'low/uncertain_data_40/'
     
    dataset_t_ik = crowd_test(
        imgdir = uncertain_folder,
        maskdir='low/uncertain_label/',
